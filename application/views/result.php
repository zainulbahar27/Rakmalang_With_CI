<!-- Header Carousel -->
    ...
    <div class="col-sm-12 pull-left" style="padding:50px; padding-left:10%; font-size: 23px;">Show result of '<?php echo $key;?>'</div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-4 portfolio-item">
                            <a href="#portfolioModal<?php echo $row->id_product;?>" class="portfolio-link" data-toggle="modal">
                                ...
                                <img style="max-height:200px;" src="<?php echo base_url();?>upload/product/<?php echo $row->gambar;?>" class="img-responsive" alt="">
                            </a>
            ...
            <?php 
                ...
                <div class="portfolio-modal modal fade" id="portfolioModal<?php echo $row->id_product;?>" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-content">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-4 col-lg-offset-2" style="margin-left:10%;">
